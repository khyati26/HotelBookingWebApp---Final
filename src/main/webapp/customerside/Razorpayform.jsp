...
<body>
	<form method="POST" id="paymentform" action="https://api.razorpay.com/v1/checkout/embedded">
	  ...
	  <input type="hidden" name="callback_url" value="http://localhost:8080/OnlineHotelBookingWebap_war_exploded/paymentresponse?bookingid=${sessionScope.booking.id}">
	  <input type="hidden" name="cancel_url" value="http://localhost:8080/OnlineHotelBookingWebap_war_exploded/paymentresponse?bookingid=${sessionScope.booking.id}">
	</form> 
