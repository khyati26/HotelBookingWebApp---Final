...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index3.html" class="brand-link">
    <img src="${pageContext.request.contextPath}/admin/resources/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-5 " style="padding-left: 10px;">
      ...
      <big style="font-size:20px;color: white;"><b><c:out value="${sessionScope.user.firstName}"/> <c:out
              value="${sessionScope.user.lastName}"/></b></big>
