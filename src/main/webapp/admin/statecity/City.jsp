					...
					<table id="example" class="table table-striped table-bordered" >
						...
						<c:forEach items="${cities}" var="city">
							<tr>
								...
								<td>${city.cityName }</td>
								<td><img alt="no image found" height="100px" width="100px" src="${city.imagePath}"></td>
								<td>
									<c:if test="${city.popular == 0 }">
										<input type="checkbox" name="checklist" onclick="checkvalue(this)"
											   value="${city.id }">
									</c:if>
								...
								<td>
									...
									<a href="<%=request.getContextPath() + AdminURLConstant.DELETE_CITY_URL%>?id=${city.id}"
