                            ...
                            <form class="form-card" method="post" action="addcity" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-between text-left">
                                    <div class="form-group col-12 flex-column d-flex">
                                        <label class="form-control-label px-3">Upload City Image<span
                                ...
                                <div class="row justify-content-between text-left">
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="checkbox" value="1" id="popular" name="popular"
                                                       onblur="validate(7)">
                                                <input type="hidden" name="popular" value="0"/></td>
                                            <td>
                                                <label class="form-control-label px-3">Is this City Most Popular for
                                                    travelers in India?</label>
                                            </td>
                                        </tr>
                                    </table>
