...
<%@page import="com.narola.hotelbooking.Hotel.model.Hotel"%>
<%@page import="com.narola.hotelbooking.Hotel.dao.HotelDAOMysql"%>
								...
								<div class="row justify-content-between text-left">
									<div class="form-group col-sm-6 flex-column d-flex">
										<label class="form-control-label px-3">Room Type<span
											...
											name="name" placeholder="Enter Room Type name" onblur="validate(1)" required>
									</div>
